 ...
 *
 *  Modified by @ilGianfri to show up in the new app as a button (with icon too) - supports press, held and standby events
 *
 */
...
metadata {
	definition (name: "Xiaomi Button", namespace: "bspranger", author: "bspranger", vid: 'generic-button-2', minHubCoreVersion: "000.022.0002", ocfDeviceType: "x.com.st.d.remotecontroller") {
		capability "Actuator"
		capability "Battery"
		capability "Button"
